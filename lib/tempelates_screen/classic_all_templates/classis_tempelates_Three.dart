...
class ClassisTempelatesThree extends StatelessWidget {
            ...
            children: [
              ...
              Container(
                ...
                width: MediaQuery.sizeOf(context).width,
                  child: buildSectionTitle(title: 'Work Experience',color: fontController.isDefault.value == true ? blackColor : fontController.textColor.value)),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 15,vertical: 5),
              ...
              Container(
                  ...
                  color: classicThree,
                  width: MediaQuery.sizeOf(context).width,
                  child: buildSectionTitle(title: 'Skills'.toUpperCase(), color: fontController.isDefault.value == true ? blackColor : fontController.textColor.value)),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 15,vertical: 5),
              ...
              Container(
                  ...
                  color: classicThree,
                  width: MediaQuery.sizeOf(context).width,
                  child: buildSectionTitle(title: 'Education'.toUpperCase(),color: fontController.isDefault.value == true ? blackColor : fontController.textColor.value)),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 15,vertical: 5),
              ...
              Container(
                  ...
                  color: classicThree,
                  width: MediaQuery.sizeOf(context).width,
                  child: buildSectionTitle(title: 'Others'.toUpperCase(),color: fontController.isDefault.value == true ? blackColor : fontController.textColor.value)),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 15,vertical: 5),
                child: Row(
                  children: [
